...
<main class="black-80 helvetica mw7 center pa3 pa5-ns pt4 mw7 center">
    ...
    <div class="pb3">
        <div class="w-100 mt1">
                <h1 class="f2 f1-ns mv0">Izmena lokacije</h1>
        </div>
    </div>
    <form class="measure" method="post">
                ...
                <div class="mt3">
                    ...
                    value='<?php echo htmlspecialchars($DATA['location']->name); ?>'></input>
                </div>
                <div class="mt3">
                    <label  for="slug" class="f6 b db mb2">Slug lokacije</label>
                    ...
                    value='<?php echo htmlspecialchars($DATA['location']->slug); ?>'></input>
                </div>
                </fieldset>
                <button type='submit' class="b ph3 no-underline pv2 input-reset bg-green white br2 ba b--none grow pointer f6 dib">Izmeni lokaciju</button>
    </form>
</main>
